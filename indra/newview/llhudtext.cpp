...
void LLHUDText::render()
{
    if (!mOnHUDAttachment && sDisplayText)
    {
        ...
        // never applied.
        // <SS:Nexii> mZCompare was read before the name tag code split pulled this file out; honour it
        // again, so text that asked to draw through the scene (tracker beacons, Atmo Magic debug
        // labels) is not depth-tested against the world's depth buffer behind it.
