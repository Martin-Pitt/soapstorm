...
// Outside the domain the air is undisturbed, so reads clamp to the ambient
// wind of the nearest slab rather than to zero - clamping to zero would make
// the domain edge behave like a wall and stall the whole field.
