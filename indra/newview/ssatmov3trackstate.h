/**
 * @file ssatmov3trackstate.h
 * @brief Atmo Magic v3: which track is active at a given altitude, and how
 *        a crossing between two of them should be presented. Phase 4 of
 *        doc/atmo_magic_v3_environment.md - deliberately still not wired to
...
#ifndef SS_ATMOV3TRACKSTATE_H
#define SS_ATMOV3TRACKSTATE_H
...
public:
    ...
    // straddling SSAtmoV3Asset::visibleWaterHeight(), not passed in by the
    ...
    static SSAtmoV3TrackBlend resolve(const SSAtmoV3Asset& asset, F32 world_z,
...
private:
    ...
    static S32 trackContaining(const SSAtmoV3Asset& asset, F32 world_z);
    ...
    static bool nearestBoundary(const SSAtmoV3Asset& asset, S32 primary, F32 world_z,
                                S32& out_neighbor, F32& out_distance);
};

// </SS:Nexii>

#endif // SS_ATMOV3TRACKSTATE_H
