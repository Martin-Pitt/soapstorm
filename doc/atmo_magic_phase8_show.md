...
Against Earth's radius that is 127 km for a 1000 m deck seen from the ground, 139 km from 20 m up, and 244 km from a
1000 m sky build. The user's "100-200 km" is the deck's term, not the eye's: at avatar eye height the eye's own
