...
// Accepts EEP settings and notecard drops onto the floater.
...
// A dropped EEP sky/water stamps its values into the edited track at the current phase.
...
// Creates a fresh seeded environment notecard and loads it.
