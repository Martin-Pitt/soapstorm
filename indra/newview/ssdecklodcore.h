...
namespace SSDeckLod
{
    ...
    // axis) - the three displacements ssvolcloud.cpp's buildDeck stacks onto a cell's centre before placeWorld. An
    // expression of the LOCKSTEP constants those two cores already own, not a fourth hand-tuned literal.
